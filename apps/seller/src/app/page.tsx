...
export default function Home() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-6">판매자 포털</h1>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        <div className="bg-blue-50 p-8 rounded-lg shadow">
          <h2 className="text-2xl font-semibold mb-4">
            {isLoggedIn ? `환영합니다, ${user.name}님` : '판매자 로그인'}
          </h2>
          <p className="mb-6">
            {isLoggedIn 
              ? '판매자 대시보드에서 상품과 주문을 관리하세요.' 
              : '로그인하여 판매자 기능을 이용하세요.'}
          </p>
        ...
        <div className="bg-gray-50 p-8 rounded-lg shadow">
          <h2 className="text-2xl font-semibold mb-4">판매자 정보</h2>
          <p className="mb-4">판매자 포털에서 제공하는 다양한 기능을 활용하세요.</p>
          {isLoggedIn ? (
